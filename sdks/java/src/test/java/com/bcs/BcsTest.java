...
class BcsTest {
  ...
  class Uleb128Tests {
    ...
    void rejectNonCanonicalEncoding2Byte() {
      ...
      BcsError error =
          assertThrows(BcsError.class, () -> Uleb128.decode(new byte[] {(byte) 0x80, 0x00}, 0));
    ...
    void rejectNonCanonicalEncoding3Byte() {
      ...
      BcsError error =
          assertThrows(
              BcsError.class, () -> Uleb128.decode(new byte[] {(byte) 0x80, (byte) 0x80, 0x00}, 0));
      assertEquals(BcsError.Type.NON_CANONICAL_ULEB128, error.getType());
    }
    ...
    void rejectNonCanonicalEncoding5Byte() {
      ...
      BcsError error =
          assertThrows(
              ...
              () ->
                  Uleb128.decode(
                      new byte[] {(byte) 0x80, (byte) 0x80, (byte) 0x80, (byte) 0x80, 0x00}, 0));
      assertEquals(BcsError.Type.NON_CANONICAL_ULEB128, error.getType());
    }
    ...
    void rejectOverflow5ByteTooLarge() {
      ...
      BcsError error =
          assertThrows(
              ...
              () ->
                  Uleb128.decode(
                      new byte[] {(byte) 0x80, (byte) 0x80, (byte) 0x80, (byte) 0x80, 0x10}, 0));
      assertEquals(BcsError.Type.ULEB128_OVERFLOW, error.getType());
    }
  }
  ...
  class MapTests {
    ...
    void deserializeValidMap() {
      ...
      java.util.Map<Short, Short> result =
    ...
    void rejectUnsortedKeys() {
      ...
      BcsError error =
          assertThrows(
              BcsError.class, () -> des.readMap(BcsDeserializer::readU8, BcsDeserializer::readU8));
  ...
  class RoundTripTests {
    ...
    @Test
    void nestedVectors() {
      List<List<Short>> values =
          List.of(List.of((short) 1, (short) 2), List.of((short) 3, (short) 4, (short) 5));
