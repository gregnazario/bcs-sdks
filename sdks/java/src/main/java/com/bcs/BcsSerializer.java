...
public class BcsSerializer {
  ...
  /**
   * Serialize raw unsigned 128-bit integer from two longs (little-endian). This is faster than
   * BigInteger for values that fit in 128 bits.
   *
  ...
  /** Reset this serializer for reuse. More efficient than creating a new instance. */
  public void reset() {
    size = 0;
    currentDepth = 0;
  }
